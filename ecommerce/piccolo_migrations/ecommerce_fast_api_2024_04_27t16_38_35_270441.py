...
class Cart(Table, tablename="cart_product", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table(
        class_name="CartItem", tablename="cart_item", schema=None, columns=None
    )

    manager.add_table(
        class_name="PromotionalCode",
    ...
    manager.add_column(
        table_class_name="PromotionalCode",
        tablename="promo_code",
        column_name="id",
        db_column_name="id",
        column_class_name="Serial",
    ...
    manager.alter_column(
        ...
        old_params={
            "default": TimestampCustom(
                year=2024, month=4, day=4, hour=16, second=50, microsecond=43809
            )
        },
        column_class=Timestamp,
